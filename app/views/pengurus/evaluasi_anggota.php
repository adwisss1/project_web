...
if (($mode === 'add' || $mode === 'edit') && $anggota_id > 0) {
    ...
    <head>
        <meta charset="UTF-8">
        <title><?= $mode === 'add' ? 'Tambah' : 'Edit' ?> Evaluasi</title>
        <link rel="stylesheet" href="/SI-BIRAMA/public/css/style.css">
    </head>
    <body>
        <div class="layout-wrapper">
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-content">
            <div class="content">
                ...
                <br>
                <!-- <a href="beranda_pengurus.php" class="button">← Kembali ke Beranda</a> -->
            </div>
        </div>
    </div>
